...
为方便大家理解，本次新版本号定为 1.01。版本号分两部分：整数位跟随原作者版本，原作者发布新版时递增（2.01、3.01…）；小数位为中文增强版的更新序号，仅中文增强版更新、原作者未更新时才会改动（1.02、1.03…）。
...
千问3.7和GPT-6，DeepSeek4.1，GLM5.3参与翻译和部分代码逻辑与功能实现 
